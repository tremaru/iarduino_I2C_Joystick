// ПРИМЕР РАБОТЫ С КНОПКОЙ ДЖОЙСТИКА:                        //   Светодиод на плате Arduino будет светиться пока нажата кнопка.
...
void setup(){                                                //
    ...
    joy.begin(&sWire);                                       //   Инициируем работу с джойстиком, указав ссылку на объект для работы с шиной I2C на которой находится джойстик (по умолчанию &Wire).
                                                             ...
                                                             //
void loop(){                                                 //
    bool f = joy.getButton(KEY_PRESSED);                     //   Считываем состояние кнопки джойстика в переменную f.
